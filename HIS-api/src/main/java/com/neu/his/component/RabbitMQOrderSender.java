...
import com.neu.his.domain.QueueEnum;
...
public class RabbitMQOrderSender {
    ...
    public void sendMessage(Long orderId, int type, final long delayTimes) {
        ...
        //给延迟队列发送消息
        amqpTemplate.convertAndSend(QueueEnum.QUEUE_TTL_ORDER_CANCEL.getExchange(), QueueEnum.QUEUE_TTL_ORDER_CANCEL.getRouteKey(), msg, new MessagePostProcessor() {
            @Override
