...
public class AppRegistrationController {
    ...
    @ResponseBody
    public CommonResult<PmsPatientResult> login(@RequestParam("identificationNo") String identificationNo, @RequestParam("medicalRecordNo") String medicalRecordNo) {
    ...
    @ResponseBody
    public CommonResult<AppDocSkdResult> listDoctorSkd(@RequestParam("staffId") Long staffId, @RequestParam(value = "endDate", required = false) Date endDate) {
