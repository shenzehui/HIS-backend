...
public class DmsMechanicItemRecordController {
    ...
    @ResponseBody
    public CommonResult<List<DmsMechanicItemRecordResult>> listByDeptAndName(@RequestParam("deptId") Long deptId, @RequestParam("search") String search){
        List<DmsMechanicItemRecordResult> list = dmsMechanicItemRecordService.listByDeptAndName(deptId,search);
